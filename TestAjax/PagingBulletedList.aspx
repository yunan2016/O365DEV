<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PagingBulletedList.aspx.cs" Inherits="TestAjax.PagingBulletedList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div style="height: 320px; overflow: auto; overflow-y: scroll; border: solid 1px #CCCCCC;">
                ...
                <cc1:pagingbulletedlistextender id="ple" runat="server"
